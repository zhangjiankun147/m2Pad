...
/**
 * Created by LCL on 2017/11/19.
 */
public class InstallApkQuietly {
    Random random = new Random();
    public static String appFile = System.currentTimeMillis()+"updata.apk";
    ...
    public static String sdRootPath = "/system/app/"+appFile;//系统APP路径
    //    public static String sdPath = "/sdcard/update/updata.apk";//下载SD卡路径
    public static String sdPath = "/sdcard/update/"+appFile;//下载SD卡路径
...
//                intent.setDataAndType(Uri.parse(appFile), "application/vnd.android.package-archive");
//                AppInfo.globalAppContext.startActivity(intent);
    ...
    public static void openFile() {
        ...
        intent.setDataAndType(
                Uri.fromFile(new File("/sdcard/update/"+appFile)),
    ...
    public static boolean isHasfile() {
        try {
            File f = new File("/sdcard/update/"+appFile);
            if (!f.exists()) {
                return false;
            }
        } catch (Exception e) {
    ...
    public static boolean isRootHasfile() {
        try {
            File f = new File("/system/app/"+appFile);
            if (!f.exists()) {
                return false;
            }
        } catch (Exception e) {
...
//                    "exit" + "\n" +
//                    "exit";
        String paramString= "adb push "+appFile+" /system/app" + "\n" +
                "adb shell" + "\n" +
                "su" + "\n" +
                "mount -o remount,rw -t yaffs2 /dev/block/mtdblock3 /system" + "\n" +
                "cat /sdcard/update/"+appFile+" > /system/app/"+appFile+"" + "\n" +
                "mount -o remount,ro -t yaffs2 /dev/block/mtdblock3 /system" + "\n" +
                "exit" + "\n" +
                "exit";
